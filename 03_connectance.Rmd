...
When a network is given in the edge-list representation, computing the its connectance is straightforward. Let us compute the connectance for all the pollination networks available on 
