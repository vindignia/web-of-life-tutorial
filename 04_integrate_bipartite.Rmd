...
bipartite networks. 
As preliminary step to integrate <a href="https://www.web-of-life.es" target="_blank">Web of life</a> with this package one needs to convert  network data into a bipartite graph (see Section \@ref(bipartite-nw-02)).  <br>
...
Here we just focus on *connectance*, *nestedness temperature*, and *modularity*. 
